      ...
      <div className="bg-white card-box border-20">
         <h4 className="dash-title-three">Overview</h4>
          <div className="dash-input-wrapper mb-30">
            ...
            <input type="text" name="title" required placeholder="Your Property Name" />
         </div>
         <div className="dash-input-wrapper mb-30">
            <label htmlFor="">Description*</label>
            <textarea className="size-lg" name="description" required placeholder="Write about property..."></textarea>
         </div>
